...
_known_refs = ('RefSeq', 'STRING', 'GeneID', 'PIR', 'EMBL')
...
class UniprotProtein(Base):
    ...
    attributes = ['id', 'genome', 'EMBL', 'RefSeq', 'STRING', 'GeneID', 'PIR', 'Uni_name', 'taxid', 'description',
                  'updated', 'raw_record']
...
class SQLDatabase(object):
    ...
    def __init__(self, database_url):
        ...
        self.decomp = zstd.ZstdDecompressor()
